...
function run() {
    ...
    $form_data = get_form_data(
        ...
        array('school_type' => array('$in' => array('primary', 'jnr_secondary', 'ayp', 'formal'))), // query
        array('community_code', 'household_code', 'child_id', 'child_sex', 'child_age', 'child_labor'), // fields
        null, // sort
        false, // count
        0, // start
        0 // limit
